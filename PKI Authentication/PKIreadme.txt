...
Ensure you have the ESP8266 board package installed in the Arduino IDE or PlatformIO:
...
Open the gituser.ino file in Arduino IDE.

Replace the WiFi credentials with your network SSID and password.
...
It will request a challenge from the server.

The ESP8266 will sign the challenge and send the signature.

The Flask server will verify the signature and authenticate the device.
